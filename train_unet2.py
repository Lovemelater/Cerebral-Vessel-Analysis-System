...
def train():
    ...
    # 使用axis=1（冠状面切片）- 这里可以根据需要调整
    train_dataset = MRADataset(train_data, train_label, axis=1)
    val_dataset = MRADataset(val_data, val_label, axis=1)
    ...
    for epoch in range(50):
        ...
        if avg_train_dice > best_train_dice:
            ...
            torch.save(model.state_dict(), 'unet2_best_t.pth')
        ...
        if avg_val_dice > best_val_dice:
            ...
            patience_counter = 0
            torch.save(model.state_dict(), 'unet2_best_v.pth')
